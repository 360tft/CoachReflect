...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Coaching CPD Log - Track Your Professional Development | CoachReflection",
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Most major coaching federations recognise structured reflective practice as a valid form of CPD. The FA, UEFA, US Soccer, Basketball England, Rugby Football Union and many others accept documented reflection as evidence of ongoing professional development. The key requirement is that reflections are structured, dated and demonstrate learning. CoachReflection ensures all of these criteria are met automatically through its guided reflection prompts and AI analysis."
      }
    }
  ]
}
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <article>
              ...
              <div className="bg-card rounded-2xl border p-8 md:p-12">
                <div className="space-y-4 text-muted-foreground text-lg">
                  ...
                  <p>
                    ...
                    CoachReflection, every post-session reflection you write is automatically
                ...
                <Card className="border border-l-4 border-l-primary">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      CoachReflection turns this into formatted evidence automatically.
                    </p>
                  </CardContent>
                </Card>
                <Card className="border border-l-4 border-l-amber-400">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      count as CPD. Log these in CoachReflection alongside your session
                ...
                <Card className="border border-l-4 border-l-emerald-400">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      coaches all qualify as CPD activities. Use CoachReflection to capture
          ...
          {/* How CoachReflection Generates CPD Evidence */}
          <section className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="border">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      CoachReflection logs the time you spend on reflective practice and
                ...
                <Card className="border">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      plan to do next. CoachReflection generates these action plans from
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground mb-6">
                      ...
                      learning are all recognised pathways. CoachReflection provides the
                    ...
                    <p className="text-muted-foreground">
                      ...
                      development. CoachReflection supports all of these sports with
                ...
                <Card className="border">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      are two words scrawled after a long session. CoachReflection ensures
          ...
          <section className="container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
                CoachReflection adapts its CPD evidence format to your sport. The AI
          ...
          <section className="container mx-auto px-4 py-16">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                <Card className="border">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-base">How does CoachReflection generate CPD evidence automatically?</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Every time you complete a reflection in CoachReflection, the AI structures
                ...
                <Card className="border">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      latest FA guidance. CoachReflection tracks your hours automatically based
                      on your reflection activity.
                    </p>
                  </CardContent>
                </Card>
                <Card className="border">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Yes. CoachReflection Pro includes a PDF export feature specifically designed
                ...
                <Card className="border">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      ...
                      are structured, dated and demonstrate learning. CoachReflection ensures all
