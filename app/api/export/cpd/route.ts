...
<body>
  ...
  <div class="footer">
    <p>Generated by Coach Reflection on ${new Date(data.generated_at).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
    <p>This document is intended for coaching license CPD documentation purposes.</p>
    <p style="margin-top: 10px;">Coach Reflection - Part of the 360TFT family of coaching tools</p>
  </div>
