...
/**
 * Splash Screen Generator for CoachReflect
 *
...
// CoachReflect brand colors (360TFT theme)
...
const PRODUCT_NAME = 'CoachReflect';
...
async function main() {
  ...
  console.log('===========================================');
  console.log('  CoachReflect Splash Screen Generator');
  console.log('===========================================');
