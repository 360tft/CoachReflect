...
1. **What worked well?** (One specific thing)
2. **What would I change?** (One specific thing)
3. **What am I focusing on next session?** (One specific thing)
...
1. Decide on your format (phone, notebook, app)
2. Set your trigger (what existing habit will you attach this to?)
3. Commit to one week of three-sentence entries
4. At the end of the week, read back through all seven entries
5. Decide if you want to continue, adjust, or try a different format
